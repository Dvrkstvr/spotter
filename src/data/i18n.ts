...
export const DICT = {
  ...
  de: {
    ...
    coachWeekHead: 'Einheiten pro Woche', coachGearHead: 'Ausrüstung einplanen',
    ...
    promptIntro: 'Du bist ein erfahrener Trainer. Unten stehen echte Daten aus meinem Trainingstagebuch. Empfiehl mir Übungen und Wochenroutinen für mein Ziel.',
    promptGoalHead: 'MEIN ZIEL', promptWeek: '{n} Einheiten pro Woche.', promptGear: 'Ausrüstung: {gear}.',
    promptAnyGear: 'was ich habe',
    promptBalanceHead: 'MUSKELBALANCE', promptWeakHead: 'Hinten:',
    ...
    promptRuleGroup: 'group muss eines von diesen sein: {list}',
    promptRuleKind: 'equipment muss eines von diesen sein: {list}',
    ...
    importDropped: '{n} übersprungen: nennen eine Übung, die es hier nicht gibt und die nicht definiert wurde.',
    importGuessed: 'Die KI nannte eine Muskelgruppe oder Ausrüstung, die du nicht hast — diese liegen unter {group} / {kind}.',
