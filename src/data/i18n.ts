...
export const DICT = {
  en: {
    ...
    obPermsSub: 'Both optional, and neither is asked again. Spotter works without either — you only lose the one thing each does.',
  ...
  de: {
    ...
    obSkipForNow: 'Später',
    obPermsTitle: 'Zwei Dinge brauchen dein Okay',
    obPermsSub: 'Beides optional, und keins wird nochmal gefragt. Spotter funktioniert auch ohne — dir fehlt dann nur genau das, was sie können.',
