...
export const DICT = {
  en: {
    ...
    insightsBalance: 'Muscle balance', insightsBalanceHint: '% of volume, scaled to muscle size · dashed = even split',
    ...
    promptBalanceHead: 'MUSCLE BALANCE', promptBalanceUnit: '% of volume, weighted by muscle size',
  ...
  de: {
    ...
    insightsBalance: 'Muskelbalance', insightsBalanceHint: '% vom Volumen, nach Muskelgröße · gestrichelt = gleichmäßig',
    ...
    promptBalanceHead: 'MUSKELBALANCE', promptBalanceUnit: '% vom Volumen, nach Muskelgröße gewichtet',
