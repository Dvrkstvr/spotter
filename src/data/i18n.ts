...
export const DICT = {
  en: {
    ...
    insightsNeedSex: 'Standards differ by sex — set yours on the profile and your lifts get a level here.',
    levelBeginner: 'Beginner', levelNovice: 'Novice', levelIntermediate: 'Intermediate',
  ...
  de: {
    ...
    insightsNeedSex: 'Die Standards unterscheiden sich nach Geschlecht — trag deins im Profil ein, dann bekommen deine Übungen hier ein Niveau.',
    levelBeginner: 'Einsteiger', levelNovice: 'Anfänger', levelIntermediate: 'Fortgeschritten',
