...
export const DICT = {
  en: {
    ...
    authTitle: 'Confirm pairing', authHint: "Check that {name}'s phone shows the same code.",
    pairBtn: 'Pair', linkLost: 'Reconnecting…',
  ...
  de: {
    ...
    authTitle: 'Kopplung bestätigen', authHint: 'Prüft, ob {name}s Handy denselben Code zeigt.',
    pairBtn: 'Koppeln', linkLost: 'Verbinde neu …',
