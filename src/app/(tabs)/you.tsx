...
export default function YouScreen() {
  ...
  // The balance counts sets, so it needs nothing about the person — no body
  // weight, and no default standing in for the majority of phones that never
  // filled the field in.
  const recentStats = trainingStats(s.history, ex, STATS_WINDOW_DAYS);
  const allTimeStats = trainingStats(s.history, ex, null);
